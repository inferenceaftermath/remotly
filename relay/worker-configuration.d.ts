/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c28b908f9dfc8d97b9617629ef91be38)
// Runtime types generated with workerd@1.20260915.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	RL_IP: RateLimit;
	RL_TOKEN: RateLimit;
	APNS_BUNDLE_ID: "com.inferenceaftermath.remotly";
	FCM_PROJECT_ID: "flow-a014e";
	FCM_PACKAGE_NAME: "com.inferenceaftermath.remotly";
	APNS_TEAM_ID: string;
	APNS_KEY_ID: string;
	APNS_P8: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APNS_BUNDLE_ID" | "FCM_PROJECT_ID" | "FCM_PACKAGE_NAME" | "APNS_TEAM_ID" | "APNS_KEY_ID" | "APNS_P8" | "FCM_SERVICE_ACCOUNT">> {}
}
